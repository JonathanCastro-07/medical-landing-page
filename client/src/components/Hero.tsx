...
export default function Hero() {
  return (
    <section
      id="hero"
      className="bg-gradient-to-b from-white via-white to-muted pt-12 md:pt-20 pb-16 md:pb-24"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-4xl font-bold text-foreground leading-tight">
                Prontuário em segundos,
                <span className="text-primary block">
                  Você atende. A IA estrutura.
                </span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Enquanto você atende, a IA documenta a consulta, sugere
                hipóteses diagnósticas, aponta sinais de risco e traz evidências
                científicas relevantes em segundos..
              </p>
            </div>
            ...
            <div className="pt-4 border-t border-border">
              <p className="text-sm text-muted-foreground mb-3">
                Conforme com CFM, LGPD e segurança de dados
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-2xl font-bold text-primary">14</p>
                  <p className="text-xs text-muted-foreground">
                    Seções CFM Automáticas
                  </p>
                </div>
                <div>
          ...
          <div className="hidden md:flex items-center justify-center">
            <div className="relative w-full">
              ...
              <img
                src="public\img\prontuario-ia.png"
